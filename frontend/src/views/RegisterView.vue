  ...
  <div class="min-h-screen bg-bg-primary flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-500 text-sm mt-1">Napravi novi račun</p>
      </div>

      <div class="card p-6">
        <h2 class="text-lg font-semibold text-white mb-5">Registracija</h2>
        ...
        <form @submit.prevent="submit" class="space-y-4">
          ...
          <div>
            ...
            <input v-model="password" type="password" placeholder="Minimalno 6 znakova" class="input" required minlength="6" />
          </div>
      ...
      <p class="text-center text-sm text-gray-500 mt-5">
        Već imaš račun?
        <router-link to="/login" class="text-brand hover:underline font-medium">Prijavi se</router-link>
      </p>
    </div>
  </div>
</template>
